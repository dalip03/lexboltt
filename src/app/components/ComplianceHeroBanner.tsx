  ...
  return (
    <section className="md:w-[95%] relative bg-[#F6F6F6]/60 rounded-[32px] mx-auto mt-14 md:p-6 md:px-12 flex flex-col items-center">
      <div className="w-full md:max-w-6xl  px-4 py-10 text-center overflow-hidden flex flex-col items-center justify-center more ">
        ...
        <h1 className="font-bold text-2xl md:text-[48px] text-black mb-2 leading-tight max-w-4xl mx-auto">
          Transform your{" "}
          <span className="bg-primary text-white px-3 cursor-pointer py-1 rounded-md text-2xl md:text-[48px] font-bold inline-block">
            Compliance
          </span>{" "}
          From
          <br />
