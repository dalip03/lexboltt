  ...
  return (
    <section className="w-full max-w-4xl mx-auto pt-12 pb-10 px-4 flex flex-col items-center">
      ...
      <motion.h1
        ...
        className="text-black text-3xl sm:text-3px md:text-[64px] font-bold text-center mb-2 leading-tight"
      >
      ...
      <motion.p
        ...
        className="text-[#2E2E2E] text-center mb-5 sm:mb-8 max-w-2xl"
      >
